...
import { File, Folder, workspace, Project, Client } from '../supabase/supabase.types';
...
type Action =
    ...
    | {
        type: 'UPDATE_PROJECT';
        payload: { project: Partial<Project>; workspaceId: string };
    }
    | {
        type: 'SET_PROJECTS';
        payload: { projects: Project[] | [] };
    }
    // Aggiunte per Clienti
    | { type: 'ADD_CLIENT'; payload: Client }
    | { type: 'DELETE_CLIENT'; payload: string }
    | {
        type: 'UPDATE_CLIENT';
        payload: { client: Partial<Client>; clientId: string };
    }
    | {
        type: 'SET_CLIENTS';
...
const initialState: AppState = { workspaces: [], projects: [], clients: [] };
                    ...
                    if (workspace.id === action.payload.workspaceId) {
                        return {
                            ...
                            folder: workspace.folders.map((folder) => {
                                if (folder.id === action.payload.folderId) {
                                    console.log('Deleted File', action.payload.fileId);
        ...
        case 'UPDATE_PROJECT':
            return {
                ...
                projects: state.projects.map((project) => {
                    if (project.workspace_id === action.payload.workspaceId) {
                        return {
                            ...project,
        ...
        case 'DELETE_CLIENT':
            return {
                ...
                clients: state.clients.filter(
                    (client) => client.codice !== action.payload
                ),
            };
        case 'UPDATE_CLIENT':
            return {
                ...
                clients: state.clients.map((client) => {
                    if (client.codice === action.payload.clientId) {
                        return {
                            ...client,
